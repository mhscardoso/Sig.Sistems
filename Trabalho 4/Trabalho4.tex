...
\begin{align*}
  V_1(cos(2t)+jsen(2t)) + V_2(cos(-2t)-jsen(2t)) + V_3(cos(2\sqrt{3}t)+jsen(2\sqrt{3}t)) + V_4(cos(-2\sqrt{3}t)-jsen(2\sqrt{3}t)) = \\
  = (V_1+V_2)cos(2t) + (V_1-V_2)jsen(t) + (V_3+V_4)cos(2\sqrt{3}t) + (V_3-V_4)jsen(2\sqrt{3}t)
\end{align*}
